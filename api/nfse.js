...
module.exports = async function handler(req, res) {
  ...
  // Log primeiros bytes para detectar BOM ou chars inválidos
  const firstBytes = Buffer.from(xmlAssinado.slice(0, 10), "utf8");
  console.log("[nfse] Primeiros bytes hex:", firstBytes.slice(0, 6).toString("hex"), "| chars:", JSON.stringify(xmlAssinado.slice(0, 20)));
