// api/nfse.js — Integração Portal Nacional NFS-e com xml-crypto (C14N correto)
...
// ─── Assina com xml-crypto (C14N correto) ─────────────────────────────────────
function assinarXML(xmlStr, pem) {
  // xml-crypto espera o XML sem a declaração XML
